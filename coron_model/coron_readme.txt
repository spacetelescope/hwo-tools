...
When the ground based option is selected from the Observation menu, the simulator includes Earthâ€™s atmospheric transmittance and downwelling atmospheric thermal radiation. Atmospheric airglow is not yet included.
