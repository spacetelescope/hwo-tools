...
def load_catalog():
    ...
    catalog_planet['Early Mars']                    = load_normal('EarlyMars_geo_albedo.txt', 'Synthetic spectrum generated by G. Arney based on Smith et al. 2014', planetary_radius = 3400, semimajor_axis=1.52, skiprows=8)
