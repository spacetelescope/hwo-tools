PRO LUVOIR_LALANDE21185

  ;;; set integration time
  ;
  Dthr     = 1.   ;integration time (hr)
  Dt     = Dthr*3600 ;convert to (s)

  ;;; set planet parameters
  ;
  ;   spectrum
  tag = 'Lalande21185_p1bar_1hr_innerHZ'
  savdir = '/astro/users/jlustigy/Dropbox/Astronomy/Plots/coronagraph/data_files/'
  fn    = 'spectra/photo_clima_p01bar_3.6e-4_GJ876_dry.pt_fixed_filtered_hitran2012_50_100000cm_toa.rad'
  ...
  Rp    = 1.0     ;Earth radii
  r     = 0.149     ;semi-major axis (AU)
  
  ;;; set star parameters
  ;
  Teff  = 3828.   ;Sun-like Teff (K)
  Rs    = 0.393      ;star radius in solar radii
  
  ;;; set planetary system parameters
  ;
  d    = 2.5     ;distance to system (pc)
  ...
  DEVICE, /COLOR
  LOADCT, 0
  PLOT, lam, Cratio*1.e9, XRANGE=[lammin,1.6], XSTYLE=1, $
