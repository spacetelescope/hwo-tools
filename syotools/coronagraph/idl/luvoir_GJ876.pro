PRO LUVOIR_GJ876
  ...
  ;
  ;   spectrum
  tag = 'GJ876_p100bar_outerHZ'
  savdir = '/astro/users/jlustigy/Dropbox/Astronomy/Plots/coronagraph/data_files/'
  fn    = 'spectra/photo_clima_p0100bar_GJ876_dry.pt_fixed_filtered_hitran2012_50_100000cm_toa.rad'
  ...
  Rp    = 1.0     ;Earth radii
  r     = 0.23     ;semi-major axis (AU)
  
  ;;; set star parameters
  ;
  Teff  = 3473.   ;Sun-like Teff (K)
  Rs    = 0.36      ;star radius in solar radii
  
  ;;; set planetary system parameters
  ;
  d    = 4.66     ;distance to system (pc)
